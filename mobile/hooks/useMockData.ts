...
export function useUsers() { return usersData; }
export function useJobs() { return jobsData; }
export function useCredentials() { return credentialsData; }
export function useCategories() { return categoriesData; }
export function useSubscriptions() { return subscriptionsData; }
export function useReviews() { return reviewsData; }
export function useReports() { return reportsData; }
export function useDisputes() { return disputesData; }
export function useNotifications() { return notificationsData; }
export function useAnalytics() { return analyticsData; }
export function useConversations() { return conversationsData; }
export function useContent() { return contentData; }
export function useFaqs() { return faqsData; }
export function useAnnouncements() { return announcementsData; }
export function useAuditLogs() { return auditLogsData; }
